...
public class GameInstance {
	...
	public static void main(String[] args) throws IOException {
		...
		if (successful && game.getRestaurant().getBudget() >= 0) {
			...
			game.getPlayer().setScore(game.getRestaurant().getBudget());
	...
	public static void StartGame() throws IOException {
		...
		initiateFoodPrice();
		initiateEmployees();
		game = new GameController(new ArrayList<MenuItem>(menuItems),
				new ArrayList<Employee>(employees), initiateClients(), name);
	...
	public static ArrayList<Client> initiateClients() {
